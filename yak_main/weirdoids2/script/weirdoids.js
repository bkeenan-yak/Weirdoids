...
function compose_easteregg(easteregg, target, std_height, std_width) {
	...
	var location_class = (easteregg.location_class != undefined && easteregg.location_class.length > 0) ? easteregg.location_class : "none";
	...
	if ($eastereggs) {
		...
		$.each($eastereggs, function(i, easteregg) {
			...
			if (easteregg.divname == undefined) {
				...
				var divname = "eastereggdiv" + '_' + location_class + '_'
